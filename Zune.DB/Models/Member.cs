...
namespace Zune.DB.Models
{
    public class Member
    {
        ...
        public static string GetXuidFromUserName(string zuneTag) => Helpers.Hash(zuneTag);

        public static Guid GetGuidFromUserName(string zuneTag) => Helpers.GenerateGuid(zuneTag);
    }
}
